  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 h-full">
      <a href="/dashboard/upload" className="flex-1">
        <CutCornerPanel variant="shuttle-red" size="sm" className="p-6 h-full flex flex-col justify-center items-center text-center transition-transform hover:scale-[1.02]">
      ...
      <a href="/dashboard/history" className="flex-1">
        <CutCornerPanel variant="loom-iron" bordered size="sm" className="p-6 h-full flex flex-col justify-center items-center text-center transition-transform hover:scale-[1.02]">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="square" className="text-muslin mb-3">
